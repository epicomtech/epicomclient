...
{
    [Route("fornecedor/skus2?codigoProduto={CodigoProduto}&codigoSku={Codigo}&forceReprocessing={ForceNotificationPush}", "PATCH")]
    public class SkuPatchRequestQS : IEmptyResponse
    {
