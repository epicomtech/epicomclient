...
namespace Epicom.Http.Client.Tests.HttpClientTests
{
    public class GetPagedTests : BaseApiTest
    {
        ...
        public GetPagedTests()
        {
            ...
            var client = new HttpClient(fakePagedResponseHandler);
        ...
        {
            IAsyncEnumerable<FakeGetResponse> response = sut.GetPaged(new FakePagedGetRequest { Id = 123, Offset = 0, Limit = 2 });
        ...
        private string BuildLink(Uri uri, string name)
        {
